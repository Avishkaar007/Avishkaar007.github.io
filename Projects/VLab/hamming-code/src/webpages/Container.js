...
function Quiz() {
    ...
    return (
        ...
        </div><div className="box" id="Result">
                <div className="title">
                    <h2 className="heading">Result</h2>
                </div>
                <div className="desc1" >
                    <p className="desc">Hence, we have got an idea about prime numbers and can find the value of nth Prime Number using the above code.</p>
                </div>
            </div></>
    )
}
    ...
    return (
        <div className="box">
            <div className="title" id="references">
                ...
                <ol >
                    <li className="desc">Urban,M. &amp; Murach , J.(2018).Python programming.Shroff.</li><br />
                    <li className="desc">Liang ,Y. D.(2013).Introduction to programming using python.Pearson.</li><br />
                    <li className="desc">Taneja, S. &amp; Kumar,N.(2018).Python Programming-A modular approach.Pearson</li>
                </ol>
            </div>
            <div className="desc1">
